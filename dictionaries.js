...
module.exports = {
    ru: function (word) {
        var russian = {
            ...
            text1: 'Boolbi — это сайт бесплатных объявлений. Здесь вы быстро сможете найти и приобрести необходимый вам товар. Просто введите в поиске название, свяжитесь с продавцом и договоритесь о сделке. Так же, здесь вы сможете разместить ваше собственное объявление. Для этого нужно только пройти простую регистрацию, заполнить удобную форму объявления и добавить пару фотографий. Желаем вам успешных продаж и выгодных покупок.',
            text2: ''
        };
        return russian[word];
    },
